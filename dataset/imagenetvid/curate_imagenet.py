...
def make_training_pickle(num_batches, num_snippets, num_instances):
    ...
    for step in range(num_batches):
        ...
        while i < num_snippets:
            ...
            while len(all_objects) < num_instances and timeout > 0:
                timeout -= 1
                o = _get_random_object_annotation(annotation1, allow_occluded=False)
                if o == None or o['trackid'] != trackid:
                    continue
            ...
            all_images = [_get_framepath(annotation1, o['trackid'], training=True)
    ...
    output.close()
    output = open(TRAIN_SET_STATS_PKL, 'wb')
